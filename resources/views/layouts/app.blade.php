...
<head>
    ...
    <title>@yield('title', 'Sistema Contable') | MSA Facturación</title>
...
<body>
    ...
    <div class="main-wrapper">
        <!-- Top Navbar con Selectores de Empresa y Sede -->
    ...
    <!-- Modal Global de Historial y Registro de Adelantos -->
    @include('components.modal_abonos')

    <!-- Vendor Scripts: jQuery, Bootstrap 5.3, DataTables, SweetAlert2 -->
