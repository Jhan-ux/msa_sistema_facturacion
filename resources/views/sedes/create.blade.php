...
@section('title', 'Registrar Nueva Sede')
    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-1 small">
                ...
                <li class="breadcrumb-item active text-primary fw-semibold" aria-current="page">Nueva Sede</li>
            </ol>
        </nav>
        <h4 class="fw-bold mb-0 text-dark">
            <i class="fa-solid fa-location-dot text-primary me-2"></i> Registrar Nueva Sede o Sucursal
        </h4>
        <p class="text-muted small mb-0">Configure los datos de la sucursal, taller o punto de atención y asócielo a una empresa.</p>
    </div>
    <div>
        @if(request()->has('empresa_id'))
            <a href="{{ route('empresas.show', request('empresa_id')) }}" class="btn btn-outline-secondary shadow-sm fw-semibold">
                <i class="fa-solid fa-arrow-left me-1"></i> Volver a la Empresa
            </a>
        @else
            ...
            <div class="msa-card-body p-4">
                <form action="{{ route('sedes.store') }}" method="POST">
                            ...
                            <div class="input-group">
                                ...
                                <select name="empresa_id" class="form-select @error('empresa_id') is-invalid @enderror" required>
                                    ...
                                    @foreach($empresas as $emp)
                                        <option value="{{ $emp->id }}" {{ (old('empresa_id', $selectedEmpresaId) == $emp->id) ? 'selected' : '' }}>
                        ...
                        <div class="col-12 col-md-8">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror" 
                                       placeholder="Ej: Sede Principal - La Victoria / Taller Norte" value="{{ old('nombre') }}" required>
                            </div>
                            @error('nombre')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="codigo" class="form-control font-monospace text-uppercase @error('codigo') is-invalid @enderror" 
                                       placeholder="Ej: SED-01" value="{{ old('codigo') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="ciudad" class="form-control @error('ciudad') is-invalid @enderror" 
                                       placeholder="Lima, Arequipa, Trujillo..." value="{{ old('ciudad', 'Lima') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="telefono" class="form-control @error('telefono') is-invalid @enderror" 
                                       placeholder="987654321 / (01) 472-8990" value="{{ old('telefono') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="direccion" class="form-control @error('direccion') is-invalid @enderror" 
                                       placeholder="Av. Nicolás Arriola 1420, Urb. Santa Catalina" value="{{ old('direccion') }}">
                            </div>
                        </div>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        @if(request()->has('empresa_id'))
                            <a href="{{ route('empresas.show', request('empresa_id')) }}" class="btn btn-light border text-muted">
                                Cancelar
                            </a>
                        @else
                            <a href="{{ route('sedes.index') }}" class="btn btn-light border text-muted">
                                Cancelar
                            </a>
                        @endif
                        <button type="submit" class="btn btn-primary px-4 fw-bold shadow-sm">
                            <i class="fa-solid fa-floppy-disk me-1"></i> Guardar Sede
                        </button>
                    </div>
                </form>
            </div>
